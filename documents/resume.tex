...
%
%In regard to the position of Software Analyst, kindly find my resume enclosed.\\
%
%I have about 4 years of experience developing backend software services and user-facing control panels as co-founder of an electronics hardware company, along with a B.Sc. in Science. \\
%
%It should be noted that I have no experience with node.js or React, and very limited experience in javascript proper, but 5 years' in Python, C++, git, and some SQL.\\
%
%I look forward to the challenging environment the CLS can offer.\\

In regard to the Berkeley Lab position of Computational Physics Software Engineer, kindly find my application enclosed.\\
...
A variety of independent projects low-energy plasma physics, 

It should be noted that I have only limited experience with machine learning in particular.\\
