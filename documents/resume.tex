...
In regard to the position of Controls Analyst, kindly find my resume enclosed.\\

I have experience with C++, Linux, embedded devices, and build systems as co-founder of an electronics hardware company, along with a B.Sc. in Science. \\

It should be noted that I have no experience with EPICS or with accelerator controls and DAQ in general.\\

I look forward to the challenging environment the CLS can offer.\\
...
%
%In regard to the LBNL position of Computational Physics Software Engineer, kindly find my application enclosed.\\
%
%I have 5 years of experience in C++ and Python, a B.Sc. in Science, and particular interest in the implementation of numerical codes with CUDA, OpenCL, and OpenMP. \\
%
%A variety of independent and team projects in diverse subjects have required overcoming unique computational demands. My modest hardware background might occasionally be handy when working with physical detector outputs and artifacts.\\
%
%It should be noted that I have only limited experience with machine learning in particular or with HEP-specific toolchains, and my current Canadian residence may disqualify me in light of pandemic restrictions.\\
%
%I look forward to the challenging environment that PHAX can offer.\\
%
