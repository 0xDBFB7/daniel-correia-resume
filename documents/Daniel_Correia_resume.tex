...
%
%I have completed real-world projects using each of the listed technologies and others not listed, and I am confident that I can contribute to any of the subjects listed above. However, there are also certain large fields which would require a very significant time expenditure to work efficiently. Some examples of fields for which more experienced candidates :
%
%\begin{itemize}\itemoptions
%	\item R or FORTRAN
